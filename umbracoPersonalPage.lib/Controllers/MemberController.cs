...
namespace umbracoPersonalPage.lib.Controllers
{
    ...
    public class MemberController : _BaseController
    {
        ...
        public ActionResult SubmitLogin(LoginModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                if (Members.Login(model.Username, model.Password))
                {
                    ...
                    {
                        return this.RedirectToPersonalPageUmbracoPage(ConfigurationUtil.AfterLoginFormId);
                    }
                }
                else
                {
        ...
        public ActionResult Logout()
        {
            ...
            Session.Clear();
            Members.Logout();
            return this.RedirectToPersonalPageUmbracoPage(ConfigurationUtil.LoginFormId);
        }
        ...
        //                return this.RedirectToPersonalPageUmbracoPage(ConfigurationUtil.AfterPasswordResetFormId);
        //            }
        //        }
        //    }
        //    return CurrentUmbracoPage();
